...
/**
 * This file contains declares the DecredParticipantHelper class.
 * @author failips (xborci01@fit.stud.vutbr.cz / mak100@azet.sk)
 * @date 28. 1. 2021
 */

#ifndef SIMPOS_DECRED_PARTICIPANT_HELPER_H
#define SIMPOS_DECRED_PARTICIPANT_HELPER_H
...
class DecredParticipantHelper : public BitcoinNodeHelper {
    public:
    /**
    ...
    DecredParticipantHelper(std::string protocol, Address address, std::vector<Ipv4Address> peers, int noMiners,
...
#endif //SIMPOS_DECRED_PARTICIPANT_HELPER_H
